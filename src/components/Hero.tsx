  ...
  return (
    <section className="relative h-screen min-h-[700px] flex items-center overflow-hidden bg-navy">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-navy/30 via-transparent to-navy/80 z-[2]" />
      </div>
      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-12 lg:px-24 w-full relative z-10">
        <div className="max-w-4xl">
          ...
          <motion.h1
            ...
            className="text-white text-5xl md:text-8xl lg:text-[9.5rem] font-serif font-light leading-[0.9] tracking-tight mb-8"
          >
          ...
          <motion.p
            ...
            className="text-white/50 text-[1.1rem] leading-[2] max-w-[480px] font-light mb-12 italic"
          >
            {t.hero.subtext}
          </motion.p>
          ...
          >
            <button className="btn-gold" onClick={() => document.getElementById('listings')?.scrollIntoView({ behavior: 'smooth' })}>
              {t.hero.ctaList}
            </button>
            <button className="btn-ghost" onClick={() => document.getElementById('international')?.scrollIntoView({ behavior: 'smooth' })}>
              {t.hero.ctaActivate}
            </button>
          </motion.div>
        </div>
      ...
      {/* Stats Readouts */}
      <div className="absolute right-[7vw] top-1/2 -translate-y-1/2 z-10 hidden lg:flex flex-col gap-8">
        {[
